...
function page() {
  return (
    <div>
      <div
        className={`${styles.solutionHeader} animate__animated animate__backInUp pb-8`}
      >
        <Navbar />
        <div
          className={`${styles.container} text-white mt-8 mx-auto text-center`}
        >
      ...
      <div className={`${styles.contentContainer} py-10`}>
        <div className={`${styles.container} m-auto`}>
          <p style={{ lineHeight: "1.5em" }}>
            At GOI we understand the importance of finding practical and
            effective solutions to the challenges you face. Whether you're
            looking for answers to everyday problems or seeking innovative
            approaches to complex issues, we're here to help. Our Solutions
            Sector is dedicated to providing you with valuable insights, expert
            advice, and actionable steps to overcome obstacles and achieve your
            goals.
          </p>
          <h1 className="mt-4 text-red-500" style={{ fontWeight: "bold" }}>
            ...
            <hr
              ...
              style={{ width: 30, height: 10, border: "none" }}
            />
          </h1>
          <div className="grid mt-4 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-10">
            ...
            <div className="p-4 border rounded shadow-md">
              ...
              <div className="bg-grey-500">
                <p>
                  ...
                  market, you might be curious as to why we haven't yet expanded
                  our operations to include listings from foreign countries.
                  Allow us to shed light on our rationale:
                </p>
              </div>
            </div>
            ...
            <div className="p-4 border rounded shadow-md">
              ...
              <p>
                ...
                enables us to support the growth of our economy and lay a solid
            ...
            <div className="p-4 border rounded shadow-md">
              ...
              <p>
                ...
                opportunities. At Go Investment, we are committed to conducting
                thorough market research and analysis before venturing into
                international listings. This approach allows us to make informed
                decisions, identify potential challenges, and devise effective
                strategies to navigate diverse international markets
                successfully.
              </p>
            </div>
            ...
            <div className="p-4 border rounded shadow-md">
              ...
              <p>
                Providing a seamless investing experience to our investors is a
                top priority for Go Investment. Before venturing into foreign
                listings, we are investing in advanced technological
                infrastructure and finance systems. By ensuring our platform can
                handle increased investing volumes, process transactions
